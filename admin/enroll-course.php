...
<!-- Mirrored from html.themewant.com/Stecybertech/enroll-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 22:52:51 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-lg-12">
                    <div class="dashboard-banner-area-start bg_image">
                        <div class="rating-area-banner-dashboard">
                            ...
                            <a href="create-course.php" class="create-btn"><i class="fa-regular fa-circle-plus"></i> Create New Category</a>
                        </div>
            ...
            <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard theiaStickySidebar">
                        <div class="dashboard-left-single-wrapper">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="enroll-course.php" class="single-item active">
                ...
                <div class="col-lg-9">
                    <div class="exrolled-course-wrapper-dashed">
                        <h5 class="title">Online Course Categories</h5>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Courses we offer</button>
                            </li>
                        </ul>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="single-course-style-three enroll-course">
                                            ...
                                            <div class="body-area">
                                                ...
                                                <button class="rts-btn btn-border">Delete Category</button>
                                            </div>
                                        </div>
