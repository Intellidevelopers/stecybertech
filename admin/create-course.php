...
<!-- Mirrored from html.themewant.com/Stecybertech/create-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 22:59:42 GMT -->
<head>
    <meta charset="UTF-8">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="course-information-area">
                                            <div class="top-form-create-course">
                                                <div class="single-input">
                                                    <label for="name">Course Title</label>
                                                    <input name="course_title" id="course_title"  type="text" placeholder="New Course">
                                                </div>
                                                <div class="single-input">
                                                    <label for="slug">Course Slug</label>
                                                    <input name="course_slug" id="course_slug" type="text" placeholder="New Course">
                                                </div>
                                                ...
                                                <div class="single-input">
                                                    ...
                                                    <textarea name="about_course" id="about_course" placeholder="New Course"></textarea>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="generale-tab-main-wrapper">
                                                                ...
                                                                <div class="generale-tab-content">
                                                                    <div class="single-checkbox-filter">
                                                                        <div class="check-box">
                                                                            <input type="checkbox" name="content_drip_enabled" id="content_drip_enabled">
                                                                ...
                                                                <div class="choosea-category-input">
                                                                    ...
                                                                    <input name="category" id="category" type="text" placeholder="Search Course Category ex Design, Development, Business">
                                                                </div>
                                                                <div class="choosea-category-input">
                                                                    <label for="choose">Choose Price</label>
                                                                    <div class="check-box-wrapper">
                                                                        <div class="single-checkbox-filter">
                                                                            <select class="input-group mb-3" name="price_type" id="price_type">
                                                                    ...
                                                                    <div class="regular-price-discount-price-area">
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input name="regular_price" id="regular_price" type="number" class="form-control" placeholder="regular Price" aria-label="Username" aria-describedby="basic-addon1">
                                                                        </div>
                                                                        <div class="input-group mb-3">
                                                                            <span class="input-group-text" id="basic-addon2">$</span>
                                                                            <input name="discount_price" id="discount_price" type="number" class="form-control" placeholder="Discounted Price" aria-label="Username" aria-describedby="basic-addon1">
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="accordion" id="accordionExampls2">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExampls2">
                                    <div class="accordion-body">
                                        <h6 class="title">Course Video</h6>
                                        ...
                                        <select name="video_source" id="video_source">
                                            ...
                                            <input name="video_link" id="video_link" type="text" placeholder="Please Enter your Video Link">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion" id="accordionExampls6">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseSix" class="accordion-collapse collapse show" aria-labelledby="headingSix" data-bs-parent="#accordionExampls6">
                                    <div class="accordion-body">
                                        <div class="additional-data-form">
                                            <!-- single input form -->
                                            <div class="single-input-area">
                                                <label for="learn">What Will I Learn?</label>
                                                <textarea name="what_will_learn" id="what_will_learn" placeholder="Write here the course benefits (One per line)"></textarea>
                                            </div>
                                            <!-- single input form end -->
                                            <!-- single input form -->
                                            <div class="single-input-area mt--25">
                                                <label for="target">Targeted Audience</label>
                                                <textarea name="target_audience" id="target_audience" placeholder="Specify the target audience that will benefit the most from the course. (One line per target audience.)"></textarea>
                                            </div>
                                            <!-- single input form end -->
                                            <div class="course-duration-input-area">
                                                <div class="half-single-input">
                                                    <p>Total Course Duration</p>
                                                    <input name="course_duration_hour" id="course_duration_hour" type="number" placeholder="00">
                                                    <label for="hour">Hour</label>
                                                </div>
                                                <div class="half-single-input">
                                                    <input name="course_duration_min" id="course_duration_min" type="number" placeholder="00">
                                                    <label for="min">Min</label>
                                                </div>
                                            </div>
                                            <div class="single-input-area mt--25">
                                                <label for="meterials">Materials Included</label>
                                                <textarea name="materials_included" id="materials_included" placeholder="A list of assets you will be providing for the students in this course (One Per line)"></textarea>
                                            </div>
                                            <div class="single-input-area mt--25">
                                                <label for="meterials-2">Requirements/Instructions</label>
                                                <textarea name="requirements_instructions" id="requirements_instructions" placeholder="Additional requirements of special instructions for the students (one per line) "></textarea>
                                            </div>
                                            <div class="single-input-area mt--25">
                                                <label for="tags">Course Tag</label>
                                                <textarea name="course_tags" id="course_tags" placeholder="Search Course Tags ex. Design , Development, Business"></textarea>
                                            </div>
                                            <div class="single-input-area mt-25">
                                                <label for="action" class="form-label">Select Status</label>
                                                <select class="form-select" id="action" name="status" required>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="preview-course-button-area">
                                                    ...
                                                    <button class="rts-btn btn-border" name='publish' type='submit'>Publish <i class="fa-light fa-arrow-right"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from html.themewant.com/Stecybertech/create-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 23:00:04 GMT -->
</html>