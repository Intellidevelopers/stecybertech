...
<!-- Mirrored from html.themewant.com/Stecybertech/my-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 23:00:04 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        ...
                        <div class="dashboard-left-single-wrapper mt--40">
                            ...
                            <!-- single item -->
                            <a href="my-course.php" class="single-item active">
    ...
    <div class="exrolled-course-wrapper-dashed">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Published (<?php echo count($publishedCourses); ?>)</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Pending (<?php echo count($pendingCourses); ?>)</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Draft (<?php echo count($draftCourses); ?>)</button>
            </li>
        </ul>
        <div class="tab-content mt--30" id="myTabContent">
                ...
                <div class="row g-5">
                    <?php foreach ($publishedCourses as $course): ?>
                        ...
                        <div class="rts-single-course">
                                <a href="single-course.php?id=<?php echo $course['id']; ?>" class="thumbnail">
                                    <img src="uploads/<?php echo $course['thumbnail_url']; ?>" alt="course">
                                </a>
                                ...
                                <div class="lesson-studente">
                                    <div class="lesson">
                                        ...
                                        <span><?php echo $course['course_duration_hour'] . 'h ' . $course['course_duration_min'] . 'm'; ?></span>
                                    </div>
                                    <div class="lesson">
                                        <i class="fa-light fa-user-group"></i>
                                        <span>Status: <?php echo $course['status'] ?? 'N/A'; ?></span>
                                    </div>
                                </div>
                                <a href="single-course.php?id=<?php echo $course['id']; ?>">
                                    <h5 class="title"><?php echo $course['course_title']; ?></h5>
                                </a>
                                <p class="teacher"><?php echo $course['course_tags']; ?></p>
                                <div class="rating-and-price">
                                    <div class="rating-area">
                                        <span><?php echo $course['price_type'] ?? 'N/A'; ?></span>
                                        <div class="stars">
                                            <ul>
                                                <?php for ($i = 0; $i < 5; $i++): ?>
                                                    <li><i class="fa-sharp fa-solid fa-star<?php echo $i < ($course['rating'] ?? 0) ? '' : '-regular'; ?>"></i></li>
                                                <?php endfor; ?>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="price-area">
                                        <div class="price">
                                            <?php echo $course['discount_price'] ? $course['discount_price'] : $course['regular_price']; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Repeat for Pending and Draft Tabs -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Quick action</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="action" class="form-label">Change Course Status</label>
                        <select class="form-select" id="action" name="action">
                            <option value="" disabled selected>Select an action</option>
                            <option value="disable">Published</option>
                            <option value="delete">Pending</option>
                            <option value="change_status">draft</option>
                        </select>
                    </div>
                   
                    <button type="submit" class="rts-btn btn-primary mb-3">Submit</button>
                        <input type="hidden" name="course_id" value="1"> <!-- Use the course ID -->
                        <input type="hidden" name="new_status" value="1"> <!-- 1 for enable, 0 for disable -->
                        <button type="submit" class="rts-btn btn-border" name="toggle_course_status">Enable Course</button>
                        <br>
                        <button type="submit" class="btn-danger delete-btn mb-3" data-id="<?= $course['id']; ?>">Delete Course</button>
                                                </form>
                </div>
            </div>
        </div>
            ...
            item.addEventListener('click', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'course-delete.php?id=' + userId;
                    }
                });
            });
        });
