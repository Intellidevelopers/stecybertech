...
<!-- Mirrored from html.themewant.com/Stecybertech/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 22:54:27 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="header-top-one">
                            <div class="left-information">
                                <a href="mailto:someone@example.com" class="email"><i class="fa-light fa-envelope"></i>stecybertech@gmail.com</a>
                                <a href="tel:+4733378901" class="email"><i class="fa-light fa-phone"></i>0808 888 6823</a>
                            </div>
                            ...
                            <div class="main-nav-one">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="">
                                            <a class="nav-link" href="blog.html">Terms & Conditions</a>
                                        </li>
                                        <li class="">
                        ...
                        <div class="header-right-area-one">
                            ...
                            <div class="buttons-area">
                                <?php if (isset($_SESSION['user_id'])): ?>
                                    ...
                                    <a href="dashboard.php" class="rts-btn btn-primary">Dashboard</a>
                                    ...
                                    <div class="category-search-input">
                                        <div class="select-banner-search-left">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H3V3H0V0ZM6 0H9V3H6V0ZM3 6.00001H0V9.00001H3V6.00001ZM6 6.00001H9V9.00001H6V6.00001ZM3 12H0V15H3V12ZM6 12H9V15H6V12Z" fill="#553CDF" />
    ...
    <div class="why-choose-us bg-blue bg-choose-us-one bg_image rts-section-gap shape-move">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl--90 mt_md--50 mt_sm--20 pl_md--15 pl_sm--10">
                    <div class="title-area-left-style">
                        ...
                        <h2 class="title">Stecybertech Your Path to
                    ...
                    <a href="course-five.html" class="rts-btn btn-primary-white with-arrow">View All Course <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="shape-image">
            ...
            <div class="shape three" data-speed="0.04" data-revert="true"><img src="assets/images/banner/16.png" alt=""></div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move">
                        <div class="title-area-left-style">
                            ...
                            <h2 class="title mb--25">Build your Skills Certificate From <br> the Stecybertech Online course</h2>
                        ...
                        <div class="footer-singl-wized left-logo">
                            ...
                            <div class="body">
                                ...
                                <ul class="wrapper-list">
                                    <li><i class="fa-regular fa-location-dot"></i>Kwara ilorin, Nigeria </li>
                                    <li><a href="call-to_61485826710.html"><i class="fa-regular fa-phone"></i>+(234) 808-888-6823</a></li>
                                </ul>
                            </div>
                        </div>
...
<!-- Mirrored from html.themewant.com/Stecybertech/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 22:55:00 GMT -->
</html>